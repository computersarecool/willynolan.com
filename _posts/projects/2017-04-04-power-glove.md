...
had been designed and manufactured, adding a bluetooth module, accelerometer (for positional data) and 
accessing the Power Glove’s built-in bend sensors was a straightforward process.'
