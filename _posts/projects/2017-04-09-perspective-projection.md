...
sections:
    - content:
        ...
        - p: 'In order to make a significantly interesting projection project, the concept of 
            <i>perspective</i> must be addressed.'
    ...
    - content:
        ...
        - raw: '<imgsrc="/assets/media/projects/perspective-projection/fifth.png" alt="Colored Cube" height="325" width="325">'
