...
media:
  - type: image
    url: "/assets/media/research/hdr/first.jpg"
  ...
  - type: image
    url: "/assets/media/research/hdr/third.jpg"
    alt: "Images at different shutter speeds"

sections:
  -
    - p: 'Today High Dynamic Range Images (HDRI) are commonplace. Many smartphones contain built-in support for HDR 
images and some even default to using HDR to capture images.'

    - p: 'Fundamentally dealing with HDR data is all about capturing the radiance of the scene. A naive thought would 
...
images.'
  ...
  -
    - p: 'With a stack of aligned images at different exposures (such as the third featured image) the non-linear 
...
knowable?</a> M.D. Grossberg, S.K. Nayar'
