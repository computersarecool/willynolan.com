...
figures:
  - type: figure3
    ...
    imgs:
      -
        src: "/assets/media/research/hdr/first.jpg"
  ...
  - type: figure
    ...
    imgs:
      -
        src: "/assets/media/research/hdr/third.jpg"
        alt: "Texture Mapping LEDs"
...
images.'
  ...
  -
    - p: 'With a stack of aligned images at different exposures (such as in the last figure) the non-linear 
